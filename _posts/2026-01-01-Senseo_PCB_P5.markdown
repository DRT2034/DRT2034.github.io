...
But here once again, the D latch isn’t perfect as it fixes correctness but not coordination. In large systems this becomes a little problematic. As such, the **clock** is introduced. The big idea is synchronization, such that all memory updates at the same exact time. We therefore build a flip-flop. 